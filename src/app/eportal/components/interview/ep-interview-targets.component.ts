...
import { DlgAddTargetComponent } from './dlgtarget.component';

/**
 * Component: Ročný rozhovor - nastavenie cieľov
 */
@Component({
  templateUrl: './ep-interview-targets.component.html',
  styleUrls: ['../eportal.css']
})
export class EpInterviewTargetsComponent {
  @Input()
  public parent: any;
  public data: any;
  public idl: string;
