...
/**
 * Component: Zoznam uskutočnených Code Review
 */
@Component({
  templateUrl: './ep-reviews.component.html',
  styleUrls: ['../eportal.css']
})
export class EpReviewsComponent implements OnInit, AfterViewInit {
  public data: any;
  ...
  public ngAfterViewInit(): void {
    ...
    this.searchlist.open(this.eportalSvc.listReviews, this.id);
  }

  public changeUrl(type: string = 'reviews'): void {
    let id = '';
