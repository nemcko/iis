...
import { DlgCourseComponent } from './dlgcourse.component';

/**
 * Component: Zoznam absolvovaných kurzov
 */
@Component({
  templateUrl: './ep-courses.component.html',
  styleUrls: ['../eportal.css']
})
export class EpCoursesComponent implements OnInit, AfterViewInit {
  public data: any;
  ...
  public ngAfterViewInit(): void {
    ...
    this.searchlist.open(this.eportalSvc.listCourses, this.id);
  }

  public changeUrl(type: string = 'courses'): void {
    let id = '';
  ...
  public updCourse(id: string): void {
