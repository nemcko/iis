...
import { DlgCertComponent } from './dlgcert.component';

/**
 * Component: Zoznam certifikátov
 */
@Component({
  templateUrl: './ep-certificates.component.html',
  styleUrls: ['../eportal.css']
})
export class EpCertificatesComponent implements OnInit, AfterViewInit {
  public data: any;
  ...
  public ngAfterViewInit(): void {
    ...
    this.searchlist.open(this.eportalSvc.listCertificates, this.id);
  }

  public changeUrl(type: string = 'certificates'): void {
    let id = '';
