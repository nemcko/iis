...
/**
 * Component: Zoznam Close-out hodnotenií projektov
 */
@Component({
  templateUrl: './ep-closeouts.component.html',
  styleUrls: ['../eportal.css']
})
export class EpCloseoutsComponent implements OnInit, AfterViewInit {
  public data: any;
  ...
  public ngAfterViewInit(): void {
    ...
    this.searchlist.open(this.eportalSvc.listCloseouts, this.id);
  }

  public changeUrl(type: string = 'closeouts'): void {
    let id = '';
